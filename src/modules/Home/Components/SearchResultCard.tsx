...
const Index = ({ resturentObject }: ResturentCardProps) => {
    ...
    const res = useMemo(() => {
        ...
        const entityType: "restaurant" | "universal_dish" =
            (resturentObject?.entityType || "restaurant") as
                | "restaurant"
                | "universal_dish";
        const clickUrl =
    ...
    return (
        ...
        <Link to={res?.clickUrl} className=" searchCard flex px-1 ">
            ...
            <div className="p-2">
                {res.entityType === "restaurant" ? (
                    <div className="">
                        <h4 className="font-bold">
                            {res?.resturantOrDishName}
                        </h4>
                    ...
                    <div className="py-1">
                        ...
                        <h4 className="text-[14px] font-semibold">Dish</h4>
                    </div>
                )}
            </div>
        </Link>
